...
DEFAULT_RULES_YAML = """\
# cicd-aiops policy rules — hot-reloaded on change (no restart needed).
...
risk_tiers:
  - name: high-risk-requires-approver
    ...
    reason: >-
      ...
      CICD_AUDIT_APPROVED_BY (and CICD_AUDIT_RATIONALE) before the call.

# deny:
#   - name: no-prod-artifact-deletes
#     operations: ["delete_artifacts"]
#     environments: ["production"]
#     reason: "Artifact deletion in production goes through change management."
